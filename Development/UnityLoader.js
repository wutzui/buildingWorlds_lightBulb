...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'light_bulb_0913_3.data';
    var REMOTE_PACKAGE_BASE = 'light_bulb_0913_3.data';
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 3759095;
      var PACKAGE_UUID = '167e89a0-8ad1-46a6-8aa4-fe8fdf3d1c9e';
...
Module['FS_createPath']('/Managed/mono', '2.0', true, true);
    ...
    DataRequest.prototype = {
      ...
      new DataRequest(0, 986159, 0, 0).open('GET', '/data.unity3d');
    new DataRequest(986159, 986178, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(986178, 989090, 0, 0).open('GET', '/preserved_derived_types.xml');
    new DataRequest(989090, 2856498, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(2856498, 3731470, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(3731470, 3759095, 0, 0).open('GET', '/Managed/mono/2.0/machine.config');
    ...
    function processPackageData(arrayBuffer) {
      ...
      DataRequest.prototype.byteArray = byteArray;
          ...
          Module['removeRunDependency']('datafile_light_bulb_0913_3.data');

    };
    Module['addRunDependency']('datafile_light_bulb_0913_3.data');
